  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative py-24 sm:py-28 md:py-36 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900" style={{ "--foreground": "210 10% 92%", "--card-foreground": "210 10% 92%", "--muted-foreground": "220 8% 55%", "--border": "220 12% 20%", "--card": "220 14% 11%", "--muted": "220 12% 16%" } as React.CSSProperties}>
        ...
        {/* Wave divider at top */}
        <div className="absolute top-0 left-0 right-0 overflow-hidden pointer-events-none -translate-y-[99%] hidden sm:block" aria-hidden="true">
        ...
        <div className="relative mx-auto max-w-6xl px-4 text-center sm:px-6">
          <FadeIn>
            ...
            <h2 className="mt-6 text-3xl font-extrabold tracking-tight text-white sm:text-4xl md:text-5xl">
              ...
              <span className="tim-gradient-text-light">mais eficiência</span>
            </h2>
          ...
          <FadeIn delay={200}>
            <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center sm:gap-5">
              <Link
                ...
                className="tim-glow-button group relative z-10 flex w-full items-center justify-center gap-2 rounded-2xl bg-primary px-9 py-4 text-base font-bold text-primary-foreground shadow-2xl shadow-primary/30 transition-all hover:bg-primary/90 hover:shadow-primary/40 hover:-translate-y-1 hover:scale-[1.01] sm:w-auto"
              >
          ...
          <FadeIn delay={350} direction="none">
            <div className="mt-10 inline-flex items-center gap-2.5 rounded-2xl border border-slate-700 bg-slate-800/50 px-5 py-2.5">
      ...
      {/* Footer */}
      <footer className="relative border-t border-slate-800 bg-slate-900" style={{ "--foreground": "210 10% 92%", "--muted-foreground": "220 8% 55%", "--border": "220 12% 20%" } as React.CSSProperties}>
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-14">
          <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
            ...
            <div>
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500">Produto</h4>
            ...
            <div>
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500">Conta</h4>
              <ul className="mt-4 space-y-2.5">
                {isSignedIn ? (
            ...
            <div>
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500">Contacto</h4>
              <ul className="mt-4 space-y-2.5">
                <li>
          ...
          <div className="mt-10 border-t border-slate-800 pt-8">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <div className="flex items-center gap-4">
                <span className="flex items-center gap-1.5 rounded-xl border border-slate-700 bg-slate-800/50 px-3 py-1.5 text-xs font-bold text-slate-400">
