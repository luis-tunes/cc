      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-md bg-muted/50 px-3 py-2">
            <p className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Proveitos</p>
            <p className="mt-0.5 text-sm font-semibold text-foreground">{fmt(ircEstimate.revenue)}</p>
          </div>
          <div className="rounded-md bg-muted/50 px-3 py-2">
            <p className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Custos</p>
        ...
        <div className="rounded-md border border-primary/20 bg-primary/5 px-3 py-2.5">
          <div className="flex items-center justify-between">
            <p className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground">Matéria Coletável Estimada</p>
            <span className="text-[10px] text-muted-foreground">{(ircEstimate.rate * 100).toFixed(0)}%</span>
          </div>
